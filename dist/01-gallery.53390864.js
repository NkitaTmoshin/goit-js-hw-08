...
const galleryCard = createGalleryCards((0, _galleryItems.galleryItems));
galleryDiv.insertAdjacentHTML("afterbegin", galleryCard);
function createGalleryCards(images) {
    return images.map((image)=>`<a class="gallery__item" href="${image.original}" onclick="return false;">
